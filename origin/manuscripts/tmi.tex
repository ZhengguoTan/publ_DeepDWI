...
%			(e-mail: julius.glaser@fau.de).}
	...
	\begin{abstract}
		...
		Although ZSSSL required up to 8 hours training time per slice, it is generalized to all other slices and its inference time was only 1 minute. Note that LLR required about 2 hours per slice. Overall, self-gated ZSSSL enables undersampled multi-shot iEPI acquisition without the need of navigators and offers sub-millimeter DWI at clinically feasible reconstruction time. The code is publicly available at: \url{https://github.com/ZhengguoTan/DeepDWI}.
	\end{abstract}
...
%	the exact posterior (assumed to be Gaussian distribution).
    ...
    \newcolumntype{b}{p{0.12\textwidth}}
    \begin{table*}
        \centering
        ...
        \begin{tabular}{a | b b b b}
            ...
            \hline
            Diffusion mode & \multicolumn{4}{c}{MDDW} \\
            Diffusion scheme & \multicolumn{4}{c}{monopolar} \\
            Diffusion direction & $20$ & $114$ & \multicolumn{2}{c}{$20$} \\
            $b$-value (\si{s/mm^2}) & $1000$ & 3-shell & \multicolumn{2}{c}{$1000$} \\
            $b_0$ & $1$ & $12$ & \multicolumn{2}{c}{$1$} \\
            FOV (\si{\square\mm}) & \multicolumn{4}{c}{$200$} \\
            Matrix size & \multicolumn{2}{c}{$200 \times 200$} & \multicolumn{2}{c}{$286 \times 286$} \\
            In-plane resolution (\si{\square\mm}) & \multicolumn{2}{c}{$1.0 \times 1.0$} & \multicolumn{2}{c}{$0.7 \times 0.7$} \\
            Slice thickness (\si{\mm}) & \multicolumn{2}{c}{$1.0$} & \multicolumn{2}{c}{$0.7$} \\
            Slices & $141$ & $114$ & \multicolumn{2}{c}{$176$} \\
            Navigator & \multicolumn{2}{c}{No} & Yes & No \\
            Shots & $4$ & 2 & \multicolumn{2}{c}{$3$} \\
            TR (\si{\ms}) & $7700$ & $4900$ & $15000$ & $8900$ \\
            TE (\si{\ms}) & $67$ & $70$ & $58/98.3$ & $58$ \\
            ESP (\si{\ms}) & \multicolumn{2}{c}{$1.02$} & \multicolumn{2}{c}{$1.17$} \\
            Bandwidth (\si{Hz/Pixel}) & \multicolumn{2}{c}{$1086$} & \multicolumn{2}{c}{$972$} \\
            Partial Fourier & \multicolumn{2}{c}{$6/8$} & \multicolumn{2}{c}{$5/8$} \\
            Acceleration & $1 \times 3$ & $3 \times 3$ & \multicolumn{2}{c}{$2 \times 2$} \\
