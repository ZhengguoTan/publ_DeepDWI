...
\begin{document}
	...
	In the area of parallel imaging and compressed sensing, 
	low rankness has been powerful prior knowledge for regularized iterative reconstruction.
	Mani et al.~\cite{mani_2017_mussels} developed 
	...
	Hu et al.~\cite{hu_2020_spa_llr} developed 
	magnitude-based spatial-angular locally low-rank regularization (SPA-LLR), 
	which employs locally-low rank (LLR) regularization \cite{zhang_2015_llr}
	in joint $k$-$q$-space reconstruction. 
	Tan et al.~\cite{tan_2024_naviepi} extended LLR to 
	accelerated multi-band multi-shot multi-shell reconstruciton.
	Dong et al.~\cite{dong_2025_nllr} proposed to 
	...
	Recently, algorithm unrolling emerges as an interpretable and efficient deep learning technique 
	for signal and image processing \cite{monga_2021_algunroll}. 
	...
	for accelerated parallel imaging reconstruction \cite{wang_2016_dl,hammernik_2018_varnet,yang_2018_admmnet,aggarwal_2018_modl}.
	
	Algorithm unrolling has been introduced to DWI image reconstruction.
	...
	Based on the zero-shot learning concept \cite{yaman_2022_zs}, 
	...
	To achieve submillimeter isotropic DWI at clinically feasible scan and inference times, 
	...
	Moreover, building upon the foundation of noise2noise \cite{lehtinen_2018_noise2noise,quan_2020_self2self,yaman_2022_zs}, 
	...
	parameterized by $\omega$ (refer to Figure S1 in Supplementary Information).
	...
	In addition, an ablation study that replaces the ResNet with Identity is provided in Figure S2 
	...
	\begin{figure}
		...
		\caption{Retrospective study with the fully-sampled reference data acquired by Protocol \#1.
	...
	of the proposed self-gated self-supervised ADMM unrolling method.
	...
	We also evaluate the cross-subject generalizability. 
	...
	\begin{figure*}
		...
		\caption{Validation of the proposed self-gated ADMM unrolling reconstruction 
			...
			with navigated and self-gated shot-to-shot phase maps, respectively.
			Comapred to MUSE, the ADMM unrolled reconstruction excels 
			in denoising while maintaining structural details.
			Self-gated ADMM unrolling shows improved image quality in terms of tissue delineation 
	...
	On the contrary, self-gated reconstructions show only subtle phase, 
	because shot-to-shot phase variations were estimated from the first echoes themselves.
	The reduced phase variation in the self-gated reconstruction leads to less phase ambiguity.
	...
	the self-gated ADMM unrolling reconstruction achieves strong denoising and resolves clear tissue details.
	
	
	\begin{figure*}
		\includegraphics[width=\textwidth]{figures/fig6.png}
		\caption{0.7~mm isotropic resolution DWI with the proposed self-gated ADMM unrolling
	...
	\begin{figure*}
		...
		\caption{Diffusion tensor imaging (DTI) model derived colored fractional anisotropy (cFA) maps
			...
			the proposed self-gated self-supervised ADMM unrolling reconstruction delivers clearer fiber orientations,
	...
	The proposed self-gated self-supervised ADMM unrolling is able to resolve thin fibers within gray matters,
	...
	(refer to Table S1 in Supplemenetary Information), 
	...
	\hl{(1) This work did not incorporate off-resonance correction in the reconstruction.}
	...
	(2) As this work primarily focused on the development of self-gated self-supervised unrolled reconstruction
